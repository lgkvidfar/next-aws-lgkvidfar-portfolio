...
export function Ground() {
  ...
  const gridMap: any = useLoader(TextureLoader, "/textures/car/grid.png");

  const aoMap: any = useLoader(TextureLoader, "/textures/car/ground-ao.png");

  const alphaMap: any = useLoader(TextureLoader, "/textures/car/alpha-map.png");
